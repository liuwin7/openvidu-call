...
export const SERVER_SSL_CERT = process.env.SERVER_SSL_CERT || (__dirname + '/certs/full_chain.pem');
export const SERVER_SSL_CERT_KEY = process.env.SERVER_SSL_CERT_KEY || (__dirname + '/certs/private.key');
